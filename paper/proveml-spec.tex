...
The models are meanwhile in production. Generative AI is used in at least one business function at 70\% of surveyed organizations \citep{aiindex2026}, in legal research \citep{magesh2025} and in clinical documentation \citep{wright2026}. Even systems built to cite leave about half of their sentences without full citation support \citep{liu2023verifiability,alce}, and whether a citation holds is judged by a person or by another model rather than by a deterministic check \citep{ais,citednotverified}.
