...
const store = {
  ...
  'formal:theorems.name': 'the mechanised model', 'formal:theorems.factSound': 'verified means equal to the store', 'formal:theorems.registered': 'a threshold the registry does not hold can neither verify nor fail a judgment', 'formal:theorems.checked': 'machine-checked',
...
const bound = [
  ...
  { anchor: 'Organizations deploy LLMs widely', id: 'abstract-mechanism', marks: [
      ...
      ['that verified means equal to the store and that a threshold the registry does not hold can neither verify nor fail a judgment, are machine-checked', 'that %[formal:theorems.factSound]{verified means equal to the store} and that %[formal:theorems.registered]{a threshold the registry does not hold can neither verify nor fail a judgment}, are %[formal:theorems.checked]{machine-checked}'],
    ], evidence: [
      ...
      q('formal:theorems.registered', 'a threshold the registry does not hold can neither verify nor fail a judgment', 'theorems', 'Theorems.evalAtom_tt_registered: An atom that holds names a registered threshold.', 'theorem list, Theorems.lean', 'This theorem gives the verify half; evalCond_empty and evalCond_mono (Appendix B) give the fail half: an unregistered name leaves the judgment unresolved. Fair reading?'),
